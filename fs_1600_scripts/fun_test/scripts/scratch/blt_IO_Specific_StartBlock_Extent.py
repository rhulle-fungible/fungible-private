...
class BLTSpecificBlockScript(FunTestScript):
    def describe(self):
...
class SpecificBlockIO(BLTSpecificBlockIOTestcase):
    ...
    def setup(self):
        super(SpecificBlockIO, self).setup()
    ...
    def cleanup(self):
        super(SpecificBlockIO, self).cleanup()


if __name__ == "__main__":
    blt_specific_block_io = BLTSpecificBlockScript()
    blt_specific_block_io.add_test_case(SpecificBlockIO())
    blt_specific_block_io.run()
