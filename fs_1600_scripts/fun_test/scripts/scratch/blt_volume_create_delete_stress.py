...
class BltCreateDeleteVol(FunTestScript):
    def describe(self):
...
class FunTestCase1(FunTestCase):
    def describe(self):
        ...
        3. Create volume
        4. Delete volume
        5. Repeat step 4 and 5 repeatedly
        6. Verify no error or funos crash occurs
                              """)
...
if __name__ == "__main__":
    blt_create_del_vol = BltCreateDeleteVol()
    blt_create_del_vol.add_test_case(FunTestCase1())
    blt_create_del_vol.run()
